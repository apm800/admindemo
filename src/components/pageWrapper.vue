<template>
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="index"  data-pid="index">首页</a>
                </div>
            </nav>
        ...
        <div class="footer">
            <div class="pull-right">&copy; 公司&nbsp;&nbsp;&nbsp;<a href="https://element.eleme.cn/2.0/#/zh-CN/component/installation" target="_blank">后台管理系统</a>
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            logout(){
                this.$http.get('/dc-admin/logout').then((response)=> {
