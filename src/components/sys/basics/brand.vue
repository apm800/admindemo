    ...
    export default {
        ...
        methods: { 
              refresh() {
                ...
                this.axios.post('/dc-admin/admin/brand/update',
                  {type: 'payload'}
                  ).then(res =>{
                    if (res.data.code==0) {
                        this.$message({
              ...
              requireData(page,limit,key,sort){
                this.loading1 = 1;
                this.axios.get('/dc-admin/admin/brand/list?page='+page+'&limit='+limit+'&key='+key+'&sidx='+sort.sidx+'&order='+sort.order, {type: 'payload'}
                  ).then(res =>{
                    console.log(444,res)
                    try{
