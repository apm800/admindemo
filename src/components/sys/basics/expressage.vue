<template>
    <div class="basicsExpress">
        <div style="margin: 0 10px 20px 0">
            <el-button  style="margin: 0 20px 0 0" size="mini" type="success" @click="append" v-checkup="':sys:menu:add'">添加快递</el-button>
            <el-button  style="margin: 0 20px 0 0" size="mini" type="danger" @click="open2" v-checkup="':sys:menu:add'">删除快递</el-button>
            ...
            <el-dialog :title="addType?'修改':'新增'" :visible.sync="addDialog">
                <el-form :model="ruleForm" name="addExpress" :rules="rules" ref="ruleForm">
                <!--
                    <el-form-item  v-if="addType" style='max-width: 48%;display: inline-block;' label="快递ID" :label-width="'120px'">
                ...
                -->    
                    <el-form-item  prop="name" style='max-width: 48%;display: inline-block;' label="快递名称" :label-width="'120px'">
                        <el-input v-model="ruleForm.name" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item  prop="code" style='max-width: 48%;display: inline-block;' label="快递编码" :label-width="'120px'">
                    ...
                    <el-form-item style='max-width: 48%;display: inline-block;' label="快递地址" :label-width="'120px'">
                        <el-input v-model="ruleForm.address" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item style='max-width: 48%;display: inline-block;' label="快递联系人" :label-width="'120px'">
                ...
                <div slot="footer" class="dialog-footer">
                    ...
                    <el-button  v-if="!addType" @click="resetForm('addExpress')">重置</el-button>
                    <el-button v-if="!addType" type="primary" @click="submitForm('addExpress')">确定</el-button>
                    <el-button v-if="addType" type="primary" @click="modiForm('addExpress')">确定</el-button>
                </div>
            </el-dialog>
    ...
    export default {
        ...
        methods: { 
              ...
              submitForm(formName) {
                ...
                this.axios.post('/dc-admin/admin/express/save',
                  this.ruleForm,
                  {type: 'payload'}
                  ).then(res =>{
                    console.log(444,res)
              ...
              requireData(page,limit,key,sort){
                  this.loading1 = 1;
                    this.axios.get('/dc-admin/admin/express/list?page='+page+'&limit='+limit+'&key='+key+'&sidx='+sort.sidx+'&order='+sort.order, {type: 'payload'}
                  ).then(res =>{
              ...
              //批量删除
              open2() {
                this.$confirm('此操作将永久删除选中的快递, 是否继续?', '提示', {
                  ...
                  if (this.tableChe.length==0) {
                      this.$message({
                        ...
                        this.axios.post('/dc-admin/admin/express/delete',
                          this.tableChe,
                          {type: 'payload'}
                          ).then(res =>{
                            console.log(444,res)
              ...
              //确认修改
              modiForm(){
                this.axios.post('/dc-admin/admin/express/update',
                  this.ruleForm,
                  {type: 'payload'}
                  ).then(res =>{
                    console.log(444,res)
