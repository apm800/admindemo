      ...
      <el-collapse v-model="activeNames" @change="activeZuo">
        ...
        <div class="el-buttonsp"  style="margin: 20px 10px -10px 0">
        	<!--<el-tabs v-model="activeName" @tab-click="handleClick">
			    <el-tab-pane label="用户管理" name="first">用户管理 <i>111</i> </el-tab-pane>
			...
			<el-badge :value="bubble.shouhoudiaobo==null?'0':bubble.shouhoudiaobo" class="item">
			 <el-button type="text"  @click="handleClick('shouhoudbFacTag')">售后调拨</el-button>
			</el-badge>
...
<script>
    export default {
        ...
        methods: {
            ...
            handleExport(){
				var downloadURL = "http://"+this.$store.state.xianshang+":8021/home/Baoge/importtxls"; 
			...
			handleExportsum(){
				var downloadURL = "http://"+this.$store.state.xianshang+":8021/home/Newdemand/inportsum"; 
				var form = $("<form>"); //定义一个form表单 
				form.attr('style','display:none'); //在form表单中添加查询参数 
				form.attr('target',''); 
				form.attr('method','post'); 
              ...
              handleClick(tab) {
                ...
                }else if(tab == 'shouhoudbFacTag'){
                    this.ware_house_data.param.in_type = '售后调拨'    
                }
