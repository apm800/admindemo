    ...
    <div class="TallyTop" v-checkup="'order:operation:list'">
       ...
       <span class="mustFill">*</span>
        ...
        <!--<div style="margin: 20px 10px 0 0">-->
            <!--<el-button size="mini" type="primary" @click="bookkeeping_registration" v-checkup="'order:all:submit'">全部记账登记</el-button>-->
...
<script>
    export default {
        ...
        methods: {
			...
			//导出
            handleExport(){
            	var downloadURL = "http://"+this.$store.state.xianshang+":8021/home/Baoge/exportorder";  
                ...
                for(let i in this.collect_data.param){
                  var name = '';
                  switch(i){
                    case 'begin_time':
                      name = 'start_time';
                  ...
                  a.attr('type','hidden');   
                  a.attr('name',name);   
                  a.attr('value',this.collect_data.param[i]); 
            ...
            handleExportSum(){
            	var downloadURL = "http://"+this.$store.state.xianshang+":8021/home/Newdemand/xiaoshouordersum";  
                var form = $("<form>");   //定义一个form表单  
                form.attr('style','display:none');   //在form表单中添加查询参数  
                form.attr('target','');  
                form.attr('method','post');  
              ...
              OrderSearch(){
                ...
                this.collect_data.param.batch_no = this.inputSearchBatch     
              ...
              bookkeeping_registration(){
                ...
                //this.order_flag_data.param.action_type = '1'  //1 代表登记记账
                */


                /*新版本（提交查询的整个结果集）*/

                this.collect_data_all.param = this.collect_data.param
              ...
              delete_menu1(){
                ...
                modification(val){
                  ...
                  this.order_detail_data.param.batch_no = ''//每次先清空
                  this.order_detail_data.param.batch_no = val.batch_no;//进行参数的赋值
