<template>
    <div class="compListZenter"> 
        <span style="display:block">
            <a href="http://admin.blueiec.com/bfecadmin/download/template/zicangruku.xls" download="自仓入库.xls">下载入库单模板</a>
        </span>       
        ...
        <div style="margin:20px 0">
            <!-- <el-button type="warning" @click="jiaoyan" v-checkup="'edbSelfIn_list'">查询</el-button> -->
            <el-button type="primary" @click="addDialog_select_ware=true"  v-checkup="'edbSelfIn_submit'">确认导入</el-button>
...
//                  }
                ...
                fileList:'',
                fileCon:'',
                url:'http://'+this.$store.state.xianshang+':8072/bfec-erp/edbSelfIn/upload/check',
                // url:'http://172.18.39.11:8072/bfec-erp/edbSelfIn/upload/check',
                tableData: [],
                //校验jiaoyan
                dataWa:{
                  apiName:'edbSelfIn_list',
                  param:{
                  }
                },
                //确认导入
                dataWa1:{
                  apiName:'edbSelfIn_submit',
                  param:{
                  }
                },
        ...
        methods: {
            //控制导入历史界面显示
            lishi(){
                this.$store.state.daoruHistory = 1;
            },
            // 改变店铺
            XzShop(){
                try{
...
//          删除空数组
            ...
            //查看历史
            goHistory(){
                this.$router.push({path:'/compHistory',query:{'come':'compListZenter'}})
            },
            //上传按钮
            ceshi(e) {
                this.fileCon = e;
...
//              this.fileCon = e;
        ...
        mounted() {
            ...
            contabs(this.$router);
            this.$router.push('/compListZenter')
        },
        props: {},
        watch: {}
    }
