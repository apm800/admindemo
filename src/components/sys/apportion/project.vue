<template>
    <div class="compListZenter"> 
        <span style="display:block">
            <a href="http://admin.blueiec.com/bfecadmin/download/template/rl_project.xls" download="项目信息模板.xls">下载项目信息模板</a>
        </span>       
...
//                  }
                ...
                //校验jiaoyan
                dataWa:{
                  // apiName:'rl_data_list',
                  param:{
                  }
                },
                //确认导入
                dataWa1:{
                  // apiName:'rl_data_submit',
                  param:{
                  }
                },
        ...
        methods: {
            ...
            jiaoyan(){
                ...
                this.axios.post('/dc-admin/erprldatacheck/list', 
                this.dataWa,{type: 'payload'}).then(res =>{
...
//          删除空数组
            ...
            //查看历史
            goHistory(){
                this.$router.push({path:'/rlHistory',query:{'come':'project'}})
            },
            //上传按钮
            ceshi(e) {
                this.fileCon = e;
...
//              this.fileCon = e;
            ...
            subEnter(e){
                ...
                this.axios.post('/dc-admin/erprldatacheck/upload/submit', 
                this.dataWa1,
                {type: 'payload'}
                ).then(res =>{
            ...
            importStatusfun(){
            	this.axios.get('/dc-admin/erprlimporthistory/importStatus/'+1,{type: 'payload'}
               ).then(res =>{
                	if(res.data.code==0){
