<template>
    <div class="waidataRibao animated fadeInDown">
        ...
        <div style="border-bottom:1px solid #ccc;">
            ...
            <el-button style="margin-left:20px;" type="primary" @click="chaxun" v-checkup="'ZK_oralbuserplandatatargetdaily_list'">查询</el-button>
        ...
        <el-table
            ...
            width="">
                ...
                width="120">
                    <template slot-scope="scope">
                        <span>{{ scope.row.saleAim | money}}</span>
                    </template>
                </el-table-column>
                <el-table-column
                prop=""
                ...
                width="120">
                    <template slot-scope="scope">
                        <span>{{ scope.row.saleOffTake | money}}</span>
                    </template>
                </el-table-column>
                <el-table-column
                prop="saleRate"
                ...
                width="120">
                    <template slot-scope="scope">
                        <span>{{ scope.row.sale2017 | money}}</span>
                    </template>
                </el-table-column>
                <el-table-column
                prop="saleIYA"
    ...
    export default {
        data() {
            return {
                ...
                // 查询
                dataWa:{
                  apiName:'ZK_oralbuserplandatatargetdaily_list',
                  param:{
                  }
                },
                //页面数据
        ...
        methods: {
            ...
            daochu(){
                ...
                this.daochuUrl='http://'+this.$store.state.xianshang+':8078/bfec-obtain/oralbuserplandatatargetdaily/download?&start='+this.value6[0]+'&end='+this.value6[1]+'&projectId='+this.value1
