<template>
    <div class="SKUEF animated fadeInDown">
        <template>
        <div style="border-bottom:1px solid #ccc;">
            ...
            <el-button style="margin-left:20px;" type="primary" @click="chaxun" v-checkup="'LJS_select_product_sku'">查询</el-button>
      ...
      sortable
            ...
            <el-table-column
            prop="pay_number_browser_number_rate"
            label="转化率"
      sortable
            width="">
            </el-table-column>
            <el-table-column
            prop="pay_fund_pay_number_rate"
            label="客单价"
      sortable
            width="">
            </el-table-column>
      ...
      sortable
            ...
            <el-table-column
            prop="pay_commodity_number"
            label="成交件数"
      sortable
            width="">
            </el-table-column>
            <el-table-column
            prop="pay_fund_sum_pay_fund_rate"
            label="销售百分比"
      sortable
            width="">
            </el-table-column>
    ...
    export default {
        data() {
            return {
                ...
                // 查询
                dataWa:{
                  apiName:'LJS_select_product_sku',
                  param:{
                  }
                },
                //页面数据
        ...
        methods: {
            ...
            daochu(){
                ...
                this.daochuUrl = 'http://'+this.$store.state.xianshang+':8024/oralb_excel_api/get_commodity_effect_excel/?date_start='+this.value6[0]+'&project_id='+this.value1+'&date_end='+this.value6[1]
                //http://'+this.$store.state.xianshang+':8024/oralb_excel_api/get_commodity_effect_excel/?date_start=2018-05-01&project_id=22&date_end=2018-07-22
