<template>
    <div class="MBts animated fadeInDown">
        <template>
    ...
    export default {
        ...
        methods: {
            ...
            OralBdaochu(){
                ...
                this.daochuUrl='http://'+this.$store.state.xianshang+':8024/oralb_excel_api/get_it_flow_source_new_excel/?date_start='+this.value6[0]+'&project_id='+this.value1+'&source_type='+'2'+'&date_end='+this.value6[1]
            ...
            chaxun(){
                ...
                this.dataWa.param.terminal_type = '无线端';
