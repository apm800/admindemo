<template>
    <div class="waidataTarget animated fadeInDown">
        <template>
    ...
    export default {
        ...
        methods: {
            ...
            daochu(){
                ...
                this.daochuUrl = 'http://'+this.$store.state.xianshang+':8024/oralb_excel_api/select_single_product_source_infor_new_excel/?date_start='+this.value6[0]+'&project_id='+this.value1+'&product_id='+a+'&source_type=2&date_end='+this.value6[1]
...
.waidataTarget_s .el-input__inner{
