<template>
    <div class="contendSales animated fadeInDown">
        <template>
    ...
    export default {
        ...
        methods: {
            ...
            daochu(){
                ...
                this.daochuUrl = 'http://'+this.$store.state.xianshang+':8078/bfec-obtain/competitiveproductsellinfor/download?startDate='
                +this.value6[0]+
...
.contendSales_s .el-input__inner{
