<template>
    <div class="waic2 animated fadeInDown">
        <template>
...
//              var a = this.value6.slice(0,10)
                this.daochuUrl='http://'+this.$store.state.xianshang+':8024/oralb/get_irobot_sku_pvt/?task_date='+this.value6
