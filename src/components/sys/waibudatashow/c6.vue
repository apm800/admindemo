<template>
    <div class="waic6 animated fadeInDown">
        <template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                // 查询
                dataWa:{
                  apiName:'get_transaction_profile',
                  param:{
                  	task_date:'',
                  }
                },
        ...
        methods: {
			...
			daochubtn(){
                this.daochuUrl='http://'+this.$store.state.xianshang+':8024/oralb/get_transaction_profile/?task_date='+this.value6;
