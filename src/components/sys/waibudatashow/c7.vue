<template>
    <div class="waic7 animated fadeInDown">
        <template>
        <div style="border-bottom:1px solid #ccc;">
            ...
            <el-button style=" " type="primary" @click="daochu7">导出</el-button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            // 店铺信息
            this.shopName = window.shopNamedata;
